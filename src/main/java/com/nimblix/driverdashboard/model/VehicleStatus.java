...
public class VehicleStatus {
    ...
    private String driverId; // Links to non_teaching_staff table

    @Column(name = "vehicle_number", nullable = false)
    private String vehicleNumber; // Bus number like "15A"
    ...
    private String engineStatus; // "Excellent", "Good", "Poor"
